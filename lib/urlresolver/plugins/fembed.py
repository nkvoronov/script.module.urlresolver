...
class FembedResolver(UrlResolver):
    name = "fembed"
    domains = ["fembed.com", "24hd.club", "vcdn.io", "sharinglink.club", "votrefiles.club", "femoload.xyz", "dailyplanet.pw", "vcdnplay.com"]
    pattern = r'(?://|\.)((?:fembed|24hd|vcdn|sharinglink|votrefiles|femoload|dailyplanet|vcdnplay)\.(?:com|club|io|xyz|pw))/v/([a-zA-Z0-9-]+)'
